...
These pages cover configuration for Better Auth Docs Discord Bot.

## When to Use This Section
Configuration pages explain what needs to exist before Better Auth Docs Discord Bot runs in a new environment, what each value controls, and how to reason about credentials, defaults, deployment settings, and scale controls.
